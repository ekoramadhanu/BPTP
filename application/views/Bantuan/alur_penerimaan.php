  ...
  <div id="content">
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mt-4">
            <h1 class="h3 mb-0" style="color:black" >Panduan Alur penerimaan Magang</h1>                    
        </div>
        <hr>
        <ol class="text-black">
            ...
            <li>Jika sudah menemukan nama peserta, pilih tombol dengan ikon suka untuk menerima peserta magang
              <br>
            ...
            <li>Jika tidak menyetujui, maka piih tombol dengan ikon tidak suka
              <br>
              <img src="<?=base_url('Assets/image/')?>tidak setuju_tombol.png" class="mt-1 mb-4 img-fluid img-thumbnail" width="450"> 
            </li>
        </ol>
      </div>
  </div>
