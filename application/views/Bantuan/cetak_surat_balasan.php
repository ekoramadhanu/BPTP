  ...
  <div id="content">
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mt-4">
            <h1 class="h3 mb-0" style="color:black" >Panduan Mencetak Surat Balasan</h1>                    
        </div>
        <hr>
        <ol class="text-black">
            ...
            <li>Pilih tomboh “Cari”
              <br>
              <img src="<?=base_url('Assets/image/')?>pencarian_tombol.png" class="mt-1 mb-4 img-fluid img-thumbnail" width="450">
            </li>
            <li>Jika sudah menemukan nama peserta, pilih tombol dengan ikon print
              <br>
            ...
            <li>Masukkan tempat surat yang akan dituju pada formulir Tempat Surat Dituju. Contoh “Malang”
              <br>
              <img src="<?=base_url('Assets/image/')?>suratbalasan_tempat surat.png" class="mt-1 mb-4 img-fluid img-thumbnail" width="450">
            </li>
            <li>Masukkan nomor surat yang akan dibalas pada formulir Nomor Surat yang Akan Dibalas. Contoh “5368/PL.2.1/PM/2019”
              <br>
